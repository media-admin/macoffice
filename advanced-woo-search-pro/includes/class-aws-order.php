        ...
        private function filter_results( $query ) {
            ...
            foreach( $this->products as $post_array ) {
                ...
                if ( isset( $filters['brand'] ) && is_array( $filters['brand'] ) ) {
                    ...
                    $skip = true;
                    $p_brands = get_the_terms( $post_array['parent_id'], 'product_brand' );
                ...
                if ( isset( $filters['tax'] ) && is_array( $filters['tax'] ) ) {
                    ...
                    foreach( $filters['tax'] as $taxonomy => $taxonomy_terms ) {
                        ...
                        $terms = get_the_terms( $post_array['parent_id'], $taxonomy );
                        ...
                        if ( ! is_wp_error( $terms ) && ! empty( $terms ) ) {
                            ...
                            if ( 'product_variation' === $post_array['post_data']->post_type && class_exists( 'WC_Product_Variation' ) ) {
                                $terms = array();
                                $variation_product = new WC_Product_Variation( $post_array['id'] );
