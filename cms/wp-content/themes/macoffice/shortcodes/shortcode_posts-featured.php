<div class="featured-posts__container wrapper">
	...
	$args = array(
		...
		'posts_per_page' => -1,
		'post_type' => 'post',
		'category_name' => 'lieblingsprodukte',
	...
	$loop = new WP_Query( $args );
		...
		while ( $loop->have_posts() ) : $loop->the_post(); ?>
			...
			<article class="featured-posts__card card">
				<a href="<?php the_permalink(); ?>">
					<div class="card__container wrapper">
						<p class="featured-posts__pretitle card__pretitle"><?php the_field('post-pretitle');?></p>
						<h3 class="featured-posts__title featured-posts__title card__title"><?php the_title();?></h3>
						...
						<div class="featured-posts__content card__content">
							<?php the_excerpt();?>
						</div>
					</div>
				</a>
