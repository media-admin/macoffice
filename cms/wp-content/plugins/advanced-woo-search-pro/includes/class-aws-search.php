...
class AWS_Search {
    ...
    public function search( $keyword = '', $output = 'all' ) {
        ...
        $pages_results_num     = AWS_PRO()->get_settings( 'pages_results_num', $this->form_id,  $this->filter_id );
...
//        }
    ...
    public function get_products( $posts_ids ) {
        ...
        if ( count( $posts_ids ) > 0 ) {
            ...
            $show_gtin            = AWS_PRO()->get_settings( 'show_gtin', $this->form_id, $this->filter_id );
