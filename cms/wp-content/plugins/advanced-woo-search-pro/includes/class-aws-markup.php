    ...
    class AWS_Markup {
        ...
        public function markup() {
            ...
            foreach ( $filters as $filter_id => $filter_opts ) {
                $filter_names = AWS_Helpers::translate( 'filter_name_' . $this->form_id . '_' . $filter_id, stripslashes( str_replace( array( '"',"'" ), '', strip_tags( html_entity_decode( $filter_opts['filter_name'] ) ) ) ) );
