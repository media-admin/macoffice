<?php
/**
 * Notification change price email data
 *
 * @since             1.9.2
...
/**
 * Notification change price create email
 */
class TInvWL_Public_Email_Data_Notificationprice {
	 ...
	 */
	function load_data() {
		$this->id          = $this->_name . '_notification_price_email';
		$this->title       = __( 'Wishlist Notification of change price', 'ti-woocommerce-wishlist-premium' );
