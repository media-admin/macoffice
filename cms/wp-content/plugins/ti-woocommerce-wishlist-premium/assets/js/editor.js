(function (wp) {
	...
	const TinvWLButton = (props) => {
		return el('div', {'class': 'wp-block-button  wc-block-components-product-button wc-block-button-tinvwl'},
			el('a', {
					...
					'title': __('Add to Wishlist', 'ti-woocommerce-wishlist-premium')
				},
				el('span', {'class': ''}, __('Add to Wishlist', 'ti-woocommerce-wishlist-premium')),
			));
	};
	...
	const blockConfig = {
		...
		title: __('Add to Wishlist', 'ti-woocommerce-wishlist-premium'),
		description: __('Display an add to wishlist button for the product.', 'ti-woocommerce-wishlist-premium'),
		edit: function (props) {
