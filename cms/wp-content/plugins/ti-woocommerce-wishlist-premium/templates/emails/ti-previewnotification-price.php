							...
							<table border="0" cellpadding="0" cellspacing="0" width="600" id="template_header"
								...
								<tr>
									<td id="header_wrapper" style="padding: 36px 48px; display: block;"><h1
												style='color: #ffffff; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #7797b4; -webkit-font-smoothing: antialiased;'><?php esc_html_e( 'Product Price Decreased!', 'ti-woocommerce-wishlist-premium' ); ?></h1>
									</td>
								</tr>
							</table><!-- End Header --></td>
					</tr>
												...
												<td valign="top" style="padding: 48px;">
													<div id="body_content_inner"
														...
														<p style="margin: 0 0 16px;"><?php esc_html_e( 'Hi', 'ti-woocommerce-wishlist-premium' ); ?>
															SuperUser</p>
														<p style="margin: 0 0 16px;"><?php esc_html_e( 'A product of your wishlist is on sale!', 'ti-woocommerce-wishlist-premium' ); ?></p>
