...
if (function_exists('wpm_translate_string')) {
	...
	add_filter('tinvwl_login_link_text', 'wpm_translate_string');
	add_filter('tinvwl_login_link', 'wpm_translate_string');
	...
	add_filter('tinvwl_add_to_wishlist_text_cart_item', 'wpm_translate_string');
	add_filter('tinvwl_add_to_wishlist_text_cart', 'wpm_translate_string');
	...
	add_filter('tinvwl_estimate_notes', 'wpm_translate_string');
