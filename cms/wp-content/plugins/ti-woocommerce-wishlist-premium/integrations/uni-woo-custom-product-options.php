...
if ( ! function_exists( 'tinvwl_item_price_uni_woo_custom_product_options' ) ) {
	 ...
	 * @return string
	 */
	function tinvwl_item_price_uni_woo_custom_product_options( $price, $wl_product, $product, $raw ) {
	...
	add_filter( 'tinvwl_wishlist_item_price', 'tinvwl_item_price_uni_woo_custom_product_options', 10, 4 );
} // End if().
