...
if ( ! function_exists( 'tinvwl_item_price_woocommerce_booking' ) ) {
	 ...
	 * @return string
	 */
	function tinvwl_item_price_woocommerce_booking( $price, $wl_product, $product, $raw ) {
		if ( ! class_exists( 'woocommerce_booking' ) ) {
			return $price;
		}
	...
	add_filter( 'tinvwl_wishlist_item_price', 'tinvwl_item_price_woocommerce_booking', 20, 4 );
} // End if().
