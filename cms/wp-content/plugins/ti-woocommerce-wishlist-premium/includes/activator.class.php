...
class TInvWL_Activator {
	 ...
	 * @var string
	 */
	static $_version = TINVWL_VERSION;
	...
	public static function activate() {
		...
		if ( is_null( get_option( self::$_name . '_db_verp', null ) ) ) {
	...
	public static function update() {
		$current_version = get_option( self::$_name . '_db_verp' );
		if ( ! $current_version ) {
			$current_version = get_option( self::$_name . '_db_ver' ) ? '1.0.0' : self::$_version;
		}
	...
	public static function create( $tables ) {
		...
		add_option( self::$_name . '_db_verp', self::$_version );
	...
	public static function upgrade( $tables ) {
		...
		update_option( self::$_name . '_db_verp', self::$_version );
	...
	public static function destroy( $tables ) {
		...
		delete_option( self::$_name . '_db_verp' );
	...
	public static function column_database() {
		...
		return array(
			...
			'float_1'  => array( 'FLOAT', null, false, 1 ),
	...
	private static function database_1_0_0() {
		$t = array(
			'pk_analytics' => array( 'VARCHAR', 32 ),
			'key_elem'     => array( 'VARCHAR', 255 ),
		...
		return array(
			...
			'subscribers' => array(
				'field' => array(
					...
					'wishlist_id' => 'int_0',
					'user_id'     => 'int_0',
					'user_email'  => $t['key_elem'],
					'user_type'   => $t['key_user'],
				),
			),
		);
	}
	 ...
	 * @since             1.9.0
	 */
	private static function database_1_9_0() {
		$t = array(
	 ...
	 * @since             2.0.14
	 */
	private static function database_2_0_14() {
		return array(
			'items' => array(
				'field'   => array(
					'ID'           => 'first++',
	 ...
	 * @since             2.2.0
	 */
	private static function database_2_2_0() {
		return array(
			'items' => array(
				'field'   => array(
					'ID'           => 'first++',
	...
	public static function unload_data() {
		...
		delete_option( self::$_name . '_verp' );
