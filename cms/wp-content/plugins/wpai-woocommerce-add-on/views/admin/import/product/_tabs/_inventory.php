<div class="panel woocommerce_options_panel" id="inventory_product_data" style="display:none;">
	...
	<?php if (defined('WC_VERSION') && version_compare(WC_VERSION, '9.2', '>=')):?>
        <div class="options_group">
            <p class="form-field">
                <label><?php _e("GTIN, UPC, EAN or ISBN", 'wpai_woocommerce_addon_plugin'); ?></label>
                ...
                <a href="#help" class="wpallimport-help" title="<?php _e('WooCommerce only allows numbers and hyphens in this field.', 'wpai_woocommerce_addon_plugin') ?>" style="position:relative; top:2px;">?</a>
            </p>
        </div>
	<?php endif;?>
	...
	<div class="options_group stock_fields show_if_simple show_if_variable show_if_subscription">
        ...
        <p class="form-field" style="margin-top:0;">
            <label><?php _e("Low stock threshold", 'wpai_woocommerce_addon_plugin'); ?></label>
	...
	<div class="options_group">
		...
		<p class="form-field wpallimport-radio-field">
			...
			<label for="product_stock_status_automatically" style="width:auto;"><?php _e("Set automatically", 'wpai_woocommerce_addon_plugin'); ?></label>
		...
		<div class="form-field wpallimport-radio-field">
			...
			<div class="switcher-target-product_stock_status_xpath set_with_xpath">
				<span class="wpallimport-slide-content" style="padding-left:0;">
					...
					<a href="#help" class="wpallimport-help" title="<?php _e('The value of presented XPath should be one of the following: (\'instock\', \'outofstock\', \'onbackorder\').', 'wpai_woocommerce_addon_plugin') ?>" style="position:relative; top:2px;">?</a>
				</span>
			</div>
		</div>
