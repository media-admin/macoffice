								...
								<div class="inside">
									<div class="panel-wrap product_data">
										...
										<ul style="" class="product_data_tabs wc-tabs">
											...
											<li class="inventory_tab show_if_simple show_if_variable show_if_grouped show_if_subscription show_if_variable_subscription inventory_options" style="display: block;"><a href="javascript:void(0);" rel="inventory_product_data"><?php _e('Inventory', 'wpai_woocommerce_addon_plugin');?></a></li>
											...
											<li class="variations_tab show_if_variable show_if_variable_subscription variation_options"><a title="Variations for variable products are defined here." href="javascript:void(0);" rel="variable_product_options"><?php _e('Variations','wpai_woocommerce_addon_plugin');?></a></li>
